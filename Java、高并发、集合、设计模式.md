...
![img](https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=193073563,793775102&fm=26&gp=0.jpg)
...
epoll_create创建一个类似fd_set的hashmap，epoll_ctl函数注册监听事件，epoll_wait函数等待事件的就绪。 
