...
![img](https://img-blog.csdn.net/20170102225015393)
...
Bin：该目录中存储的都是一些可以被运行的二进制文件

Sbin：该目录中存储的都是一些可以被管理员运行的二进制文件

Etc：该目录主要存储一些配置文件。

Home：表示“家”，表示除了roo用户以外其他用户的家目录，类似于windows下的User/用户目录。
