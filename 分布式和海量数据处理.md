...
分布式锁：![img](https://user-gold-cdn.xitu.io/2018/11/30/1676531f71973f37?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
- 为每个服务设定一个线程池或信号量将其隔离开来，限制其最大通过线程数，防止单个依赖耗尽Tomcat内所有用户线程。线程池隔离是用的hystrix自己的线程，而信号量隔离是用的tomcat进程直接去执行，后异步通知返回结果。
...
![](https://upload-images.jianshu.io/upload_images/6302559-c872bab5f5e48ccf.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/795/format/webp)
...
![clipboard.png](https://segmentfault.com/img/bVsWcs)
...
![img](https://user-gold-cdn.xitu.io/2019/7/4/16bbdaf91018c627?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

![img](https://user-gold-cdn.xitu.io/2019/7/4/16bbdaf91001872f?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)

解耦：

![img](https://user-gold-cdn.xitu.io/2019/7/4/16bbdaf90ff01dd1?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://raw.githubusercontent.com/doocs/advanced-java/master/images/rabbitmq-message-lose-solution.png)
...
![è¿éåå¾çæè¿°](https://img-blog.csdn.net/20170816194851267?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQveGxnZW4xNTczODc=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)

一个topic分成一个或多个partition，每个partition有多个副本分布在不同的broker中（只有leader partition会接收外部请求，其他follower partition只负责同步leader数据)

![img](https://pic3.zhimg.com/80/v2-604f846886c49517144f971cdf9c24c2_hd.jpg)

#### 1个partition只能被1个consumer gourp内的一个comsumer拥有

![img](https://img-blog.csdn.net/20170107211358384?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvdTAxMzU3MzEzMw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/Center)
...
吞吐量：kafka具有高的吞吐量，内部采用消息的批量处理。rabbitMQ支持对消息的可靠的传递，支持事务，不支持批量的操作；

可用性架构不同：rabbitmq可以基于主从架构或主备架构，kafka基于主备架构；
